...
create.getPaths = function (appPath, env) {
    ...
    var vendorRelative = env.jsVendor || 'vendor';
    return {
        app: appPath,
        js: appPath + '/' + jsRelative,
        vendor: appPath + '/' + vendorRelative,
        jsRelative: jsRelative,
        vendorRelative: vendorRelative
    };
};
...
function writeConfigFile(paths) {
    var locals = {modules: 'cjs', jsPath: paths.jsRelative, jsVendor: paths.vendorRelative};
